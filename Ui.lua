...
function Library:MakeDraggable(Instance, Cutoff)
    ...
    Instance.InputBegan:Connect(function(Input)
        if Input.UserInputType == Enum.UserInputType.MouseButton1Click or Input = Touch then
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        DisplayFrame.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1Click or Input = Touch and not Library:MouseIsOverOpenedFrame() then
            ...
            elseif Input.UserInputType == Enum.UserInputType.MouseButton1Click or Input = Touch and not Library:MouseIsOverOpenedFrame() then
                ContextMenu:Show()
                ColorPicker:Hide()
            end
        end);
